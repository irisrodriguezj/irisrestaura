...
(function () {
  const CA = {
    ...
    nav_trabajos: `Experiència laboral`,
    ...
    idx_trab_h2: `Experiència laboral`,
    ...
    par_b1_note: `Documentació i examen`,
    ...
    par_b3_note: `Consolidació i reintegració`,
    ...
    pal_b1_note: `Documentació i examen organolèptic`,
    ...
    pal_b3_note: `Consolidació i neteja`,
    ...
    pal_b5_note: `Reintegració cromàtica`,
    ...
    pin_note_fij: `Fixació i protecció del perímetre`,
    ...
    pin_note_def: `Deformacions i estrips`,
    ...
    pin_note_cons: `Consolidació i tensat`,
    ...
    pal26_meta3: `Retaule major · ESCRBCC`,
    pal26_b1_h2: `Lateral esquerre del <span class="accent">retaule major</span>.`,
    pal26_b1_p1: `Restauració del lateral esquerre del retaule major de l'església parroquial de Sant Joan Baptista de Palau de Noguera, Tremp. Aquestes pràctiques, organitzades per l'ESCRBCC i coordinades pels professors Pau Claramonte i Lídia Balust, es van desenvolupar al llarg de dues setmanes.`,
    pal26_b1_note: `ESCRBCC · Dues setmanes · 2026`,
    pal26_b2_h2: `El <span class="accent">revers</span> del retaule.`,
    pal26_b2_p1: `El treball es va dur a terme pel revers i l'anvers del retaule. Pel que fa al revers, es va netejar, desinfectar i consolidar tota l'estructura de fusta, la qual patia grans atacs xilòfags.`,
    pal26_b2_note: `Neteja · Desinfecció · Consolidació`,
    pal26_b3_h2: `L'anvers: policromia i <span class="accent">daurats</span>.`,
    pal26_b3_p1: `Pel que fa a l'anvers, la feina es va centrar en la consolidació de la policromia i daurats originals, que presentaven aixecaments i risc de despreniment. Posteriorment es va realitzar la neteja mecànica i fisicoquímica de les diferents superfícies del retaule, incloent daurats, policromies i fusta a vista.`,
    pal26_b3_note: `Consolidació · Neteja mecànica i fisicoquímica`,
    pal26_b5_h2: `Reintegració <span class="accent">cromàtica</span>.`,
    pal26_b5_note: `Reintegració de la policromia · Abans / Després`,
    ...
    cert_group_estudios: `Estudis`,
    cert_edu_0_name: `Grau en Conservació i Restauració de Béns Culturals · Especialitat de Pintura`,
    cert_edu_0_entity: `Escola Superior de Conservació i Restauració de Béns Culturals de Catalunya`,
    cert_edu_0_date: `Set. 2022 – Jun. 2027`,
    cert_edu_1_name: `Batxillerat Artístic`,
    cert_edu_1_entity: `Institut Satorras, Mataró`,
    cert_edu_1_date: `Set. 2020 – Jun. 2022`,
